...
class AVIBASELINE(nn.Module):
    def __init__(self, args):
        super(AVIBASELINE, self).__init__()
        input_dim = 28800 # 8320 + 768 (新增的文本特征维度)
        output_dim = 1
    ...
    def forward(self, batch):
        ...
        text2_features = batch['texts2']  # 新增的文本特征

        features = torch.cat([audio_features, video_features, text_features, text2_features], dim=-1)
